...
| ----------- | ----------------------------- | ------- | ------------------------------- |
| development | dev                           | dev     | @capacitor/haptics@8.0.0-dev.1  |
| next        | next (these are betas/alphas) | next    | @capacitor/haptics@8.0.0-next.1 |
| main        | latest                        | latest  | @capacitor/haptics@8.0.0        |
